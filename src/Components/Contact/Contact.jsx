...
function Contact() {
  return (
    <div name="contact" className="flex my-20 flex-col items-center justify-center mx-auto  h-screen">
      <div>
      ...
      >
        <div className="flex flex-col w-full">
          <input
            className="m-4 w-[500px] p-2 bg-[#1d2132] text-[#fff]"
            type="text"
            placeholder="Name"
            name="name"
          />
          ...
          <textarea
            ...
            placeholder="Message"
          ></textarea>
          <button className="hover:bg-main w-40 p-4 rounded-xl hover:transition-all duration-500 hover:scale-95 mx-auto text-[#fffe] font-semibold text-xl bg-[#0b4b3b]">
            Let's Collaborate
          </button>
        </div>
      </form>
